...
// prepare the Request
        StringRequest getRequest = new StringRequest(Request.Method.POST, Utils.host+"/upload/quiz/"+moduleId,
...
// add it to the RequestQueue
    ...
    byte[] getBytes(Uri uri) {
        ...
        try {
            ...
            Toast.makeText(UploadQuizActivity.this, "getBytes error:" + ex.getMessage(), Toast.LENGTH_LONG).show();
            return null;
        }
    }
