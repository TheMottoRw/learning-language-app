...
public class UpdateContentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pgdialog = new ProgressDialog(UpdateContentActivity.this);
        pgdialog.setMessage("Saving data...");
        pgdialog.setCancelable(false);
        Intent intent = getIntent();
        contentId = intent.getStringExtra("id");
        moduleId = intent.getStringExtra("module");
        edtEng.setText(intent.getStringExtra("title"));
        edtKiny.setText(intent.getStringExtra("content"));
    ...
    private void save() {
        ...
        pgdialog.show();
        try {
            body.put("title", edtEng.getText().toString().trim());
            body.put("content", edtKiny.getText().toString().trim());
